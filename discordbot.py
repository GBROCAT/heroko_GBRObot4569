...
async def on_message(message):
    ...
    if message.content == '最近合作的NFT項目':
        await message.channel.send('parody-camel 2月14日💕情人節💕 華人 X 日本人 總量6,500 稀有版 10 （免費） 第一次白 400 （1 SOL） 第二次白 500 （1.2 SOL） 公開發售 5,590 （1.4 SOL）')
    if message.content == '最近有什麼項目':
        await message.channel.send('parody-camel 2月14日💕情人節💕 華人 X 日本人 總量6,500 稀有版 10 （免費） 第一次白 400 （1 SOL） 第二次白 500 （1.2 SOL） 公開發售 5,590 （1.4 SOL）')
    if message.content == '最近有啥項目':
        await message.channel.send('parody-camel 2月14日💕情人節💕 華人 X 日本人 
                                   總量6,500 稀有版 10 （免費） 第一次白 400 （1 SOL） 第二次白 500 （1.2 SOL） 公開發售 5,590 （1.4 SOL）')
